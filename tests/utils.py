...
class UvicornGunicornPoetryContainerConfig:
    ...
    def get_uvicorn_processes(self) -> list[str]:
        ...
        uvicorn_processes: list[str] = [p for p in process_commands if "/application_root/.venv/bin/uvicorn" in p]
    ...
    def get_uvicorn_conf(self) -> dict[str, any]:
        ...
        partition: str
        last_part: str
        first_part, partition, last_part = first_process.partition("/application_root/.venv/bin/uvicorn")
